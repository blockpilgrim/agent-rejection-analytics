...
## Process
1. Read `docs/HANDOFF.md` (if it exists) — check for landmines, deviations, or dependencies from prior phases
2. Read `CONVENTIONS.md` for current patterns and anti-patterns
